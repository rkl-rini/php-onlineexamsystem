...
<div class="col-lg-6">
<span class="logo">ExamZen</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
{echo'<b> 
You can send us your feedback through e-mail on the following e-mail id:<b><br />
<div class="row">
<div class="col-md-1"></div>
<div class="col-md-10">
<b>contact@examzen.com<b></a><br /><br />
</div><div class="col-md-1"></div></div>
<p><b>Or you can directly submit your feedback by filling the enteries below:-<b></p>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Medha.jpg" width=100 height=100 alt="Medha Muppala" class="img-rounded">
		 </div>
		 <div class="col-md-5">
	<h4 style="font-family:'typo' ">Medha Muppala</h4>			<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91-8500013661</h4>
		<h4 style="font-family:'typo' ">medhamuppala@gmail.com</h4>
	...
	<div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Ravneet.jpg" width=100 height=100 alt="Ravneet Kaur" class="img-rounded">
		 </div>
		 <div class="col-md-5">
	<h4 style="font-family:'typo' ">Ravneet Kaur</h4>			<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91-7087829849</h4>
		<h4 style="font-family:'typo' ">rkloyal1122@gmail.com</h4>
		<h4 style="font-family:'typo' ">Lovely Professional University</h4></div></div>
		</p>
      </div>
